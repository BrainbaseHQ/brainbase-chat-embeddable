...
export interface BrainbaseLogoProps {
  className?: string;
  /** Color for the logo shapes (default: currentColor which inherits from parent) */
  color?: string;
  /** Color for the diamond cutout (should match the background) */
  cutoutColor?: string;
}

/**
 * Brainbase Labs logo component
 * The logo uses configurable colors for proper theming on different backgrounds.
 */
export const BrainbaseLogo: React.FC<BrainbaseLogoProps> = ({
  className,
  color = 'currentColor',
  ...
  >
    ...
    <path
      ...
      fill={color}
    />
    <circle cx="400" cy="400" r="400" fill={color} />
    <path
    ...
    <path
      ...
      fill={color}
    />
    <circle cx="400" cy="400" r="350" fill={color} />
    <path
